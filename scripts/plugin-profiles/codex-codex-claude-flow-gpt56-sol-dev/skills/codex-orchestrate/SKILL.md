...
description: Orchestrates codex-codex-claude-flow-gpt56-sol-dev workflow. Use when the Architecture Codex needs to analyze a coding request, decide whether OpenSpec is required, split tasks, prepare implementation handoff, and manage Implementation Codex execution boundaries.
---
