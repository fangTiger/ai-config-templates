...
- 用户提出中等及以上复杂度的开发需求
- 关键词：实现、设计、拆解、编排、开始开发、开始实现、handoff、交接、审查、Clarify Gate、影响面、Python 检测
...
4. 按 `AGENTS.md` 上下文优先级读取 `CODE_WIKI.md`、`docs/guide/*`、`docs/domain/*`、`docs/reference/*`、相关源码和测试；不存在时记录缺失与替代依据
